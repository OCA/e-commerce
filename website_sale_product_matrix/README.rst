...
.. 
   ...
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !! source digest: sha256:fbc3aeff053b31ae9e89cea17288431e10ac04c1813acaff4d53e1db0b84adbb
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
When adding one of these products to the cart from the shop, the product
configurator shows a *Configure options* button instead of the quantity
selector. It opens the matrix filled in with the quantities already in
the cart, as in the product page, and the variants filled in it are
listed in the configurator. On confirming it, the cart is updated with
those quantities.
