...
class ecommerce_api_log(orm.Model):
    ...
    _columns = {
        'shop_id': fields.many2one('ecommerce.api.shop', 'Ecommerce API Shop', required=True, readonly=True, select=1),
        'state': fields.selection(STATES, 'State', default='success', readonly=True, select=1),
