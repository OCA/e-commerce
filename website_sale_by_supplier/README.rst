...
========================
Website Sale By Supplier
========================

This module was written to extend the functionality of the website
to allow users to publish his suppliers products.
...
5.  Search For *Website Sale By Supplier*
6.  Install the module

Usage
=====
To use this module, you need to:
	- 	Clone repository e-commerce(https://github.com/OCA/website) from OCA 
		because this module have depedencies to *website_supplier_list*
...
website_sale_by_supplier%0Aversion:%20
