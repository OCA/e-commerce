    ...
    tour.register(
        ...
        [
            ...
            },
            {
                ...
                extra_trigger:
                    '#cart_products tr:contains("Storage Box") input.js_quantity:propValue(2)',
            ...
            },
            {
                ...
                run: function () {
                    ...
                    $('.oe_signup_form input[name="confirm_password"]').val(
                        "1admin@admin"
                    );
            ...
            },
            {
                content: "See Quotations",
                trigger:
                    '.o_portal_docs a:contains("Quotations") .badge:containsExact(2)',
            },
