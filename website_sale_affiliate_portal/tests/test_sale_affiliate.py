...
class TestWebsiteSaleAffiliatePortal(
    test_sale_affiliate.TestWebsiteSaleAffiliateProductRestriction
):
    @classmethod
    def setUpClass(cls):
                                    ...
                                    OrderedDict(
                                        [
                                            (
                                                ...
                                                {"validated": 2, "gain": 2.0},
                                            ),
                                            (
                                                "Virtual Interior Design",
                                                {"validated": 3, "gain": 3.0},
                                            ),
                                        ]
                                    ),
                                ),
                                ...
                                (
                                    ...
                                    OrderedDict(
                                        [
                                            (
                                                "Desk Combination",
                                                {"validated": 8, "gain": 8.0},
                                            ),
                                            (
                                                "Virtual Home Staging",
                                                {"validated": 1, "gain": 1.0},
                                            ),
                                        ]
                                    ),
                                ),
    ...
    def test_report_percentage_gain_type(self):
        ...
        expected_gain1 = 3 * 10.0 / 100 * self.pp1.list_price
        self.assertAlmostEqual(
            data.get("2018-01", {})
            .get("by-product", {})
            .get("Virtual Interior Design", {})
            .get("gain", 0),
            expected_gain1,
        )

        expected_gain2 = 5 * 10.0 / 100 * self.pp2.list_price
        self.assertAlmostEqual(
            data.get("2018-01", {})
            .get("by-product", {})
            .get("Virtual Home Staging", {})
            .get("gain", 0),
            expected_gain2,
        )
