...
class SaleAffiliate(models.Model):
    ...
    gain_type = fields.Selection(
        ...
        default="percentage",
        string="Gain per sale value type",
    )
    ...
    def report_data(self, month_num=None):
        ...
        month_item = {
            p.name: prod_item.copy() for p in self.restriction_product_tmpl_ids
        }
        ...
        affiliate_requests = defaultdict(int)
                ...
                (
                    ...
                    OrderedDict(
                        [
                            ...
                            ("visits", affiliate_requests.get(month, 0)),
                        ]
                    ),
                )
