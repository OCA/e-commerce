...
[website_sale_product_attribute_value_filter_existing](website_sale_product_attribute_value_filter_existing/) | 16.0.1.0.2 |  | Allow hide attributes values not used in variants
