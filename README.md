...
[website_sale_checkout_skip_payment](website_sale_checkout_skip_payment/) | 16.0.1.0.4 |  | Skip payment for logged users in checkout process
[website_sale_comparison_hide_price](website_sale_comparison_hide_price/) | 16.0.1.0.0 |  | Hide product prices on the shop
[website_sale_hide_price](website_sale_hide_price/) | 16.0.1.4.0 |  | Hide product prices on the shop
...
[website_sale_require_legal](website_sale_require_legal/) | 16.0.1.0.0 |  | Force the user to accept legal tems to buy in the web shop
