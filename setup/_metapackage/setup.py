...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo10-addon-website_sale_charge_payment_fee',
        'odoo10-addon-website_sale_charge_payment_fee_delivery',
        'odoo10-addon-website_sale_charge_payment_fee_quote',
        ...
        'odoo10-addon-website_sale_order_type',
        'odoo10-addon-website_sale_price_tier',
        'odoo10-addon-website_sale_product_unavailable',
